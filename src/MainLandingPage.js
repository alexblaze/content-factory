...
export default ({
  ...
  description = "Our WORTH in Social Medias. We are on the rise nowadays due to our valuable content creation. Our company, Content Factory, has more than 3k active interactions on a daily basis. Not only that, our baby companies like Hotels Nepal INC, Teach Me Nepal and Vacancy Nepal are also growing profusely day by day. Our presence in Social Media is growing due to our authenticity in our beloved content that we create with love."
}) => {
  /*
